...
const RegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (currentStep === totalSteps) {
      ...
      try {
        ...
        localStorage.setItem("registrationSuccess", response.message || "Registration successful!");
  ...
  const handleErrorMessage = (message) => {
    if (message.toLowerCase().includes("email") || message.includes("already exists")) {
  ...
  const stepInfo = {
    1: { heading: "Let's get started", subheading: "What should we call you?" },
    2: { heading: "Your email", subheading: "We'll use this to contact you" },
    3: { heading: "Create a password", subheading: "Make it strong and secure" },
    4: { heading: "Confirm details", subheading: "Almost there!" }
  };
...
// Add this useEffect for the particle animation (copy from LoginPage)
useEffect(() => {
  ...
  return (
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        <p className="subtitle">{registrationSuccess ? "Your account has been created" : stepInfo[currentStep].subheading}</p>
        ...
        {!registrationSuccess && (
          <form onSubmit={handleSubmit} noValidate>
            ...
            {/* Step 4: Confirm Password and Terms */}
            {currentStep === 4 && (
              <>
